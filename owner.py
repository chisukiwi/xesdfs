...
class Owner:
    ...
    @commands.command()
    async def info(self):
        """Shows info about beseria"""
        author_repo = "chisukiwi"
        red_repo = author_repo + "chisukiwi"
        server_url = "https://discord.gg/kQ62NVD"
        dpy_repo = "https://discord.gg/ChuXqtA"
        ...
        about = (
            "ce bot  [ beseria ]({}) "
            "créer par [chisukiwi]({}).\n\n"
            "Il a été fais pour les utilisateur  et pour le bien de tous !"
            "il a été créer pour tous !  [rejoignez nous !]({}) "
            "et aidez nous a nous a amélioré notre comunauté !\n\n"
            "".format(red_repo, author_repo, server_url))

        embed = discord.Embed(colour=discord.Colour.red())
        embed.add_field(name="bot créer par", value=str(owner))
        embed.add_field(name="Python", value=py_version)
        embed.add_field(name="discord.py", value=dpy_version)
        embed.add_field(name="A propos de beseria", value=about, inline=False)
        embed.set_footer(text="créer le : 01 Jan 2018 "
                         )
    ...
    def _get_version(self):
        ...
        embed = discord.Embed(title="Updates of " ,
